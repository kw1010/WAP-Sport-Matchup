...
<title>Search Friends - Sport Matchup</title>
	...
	<div id="wrapper">
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="my-events.jsp"><i class="fa fa-anchor "></i>My
							events</a></li>
					<li><a href="my-notifications.html"><i
							class="fa fa-comments-o  "></i>Notifications</a></li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">Search Friends</h1>
						<h1 class="page-subhead-line">You can search your new friends
							here.</h1>
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>@mdo</td>
									<td>2</td>
									<td><form action="addFriend" method="POST"><button class="btn btn-inverse" name="fid" value="1001">
											<i class="glyphicon glyphicon-plus"></i>Add
										</button></form></td>
								</tr>
